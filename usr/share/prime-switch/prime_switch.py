...
def switch_offload():
    os.remove('/etc/X11/xorg.conf.d/10-nvidia-prime.conf')
    ...
    nvidia_conf = open('/etc/X11/xorg.conf.d/10-nvidia-offload.conf', 'w+')
...
def switch_prime():
    os.remove('/etc/X11/xorg.conf.d/10-nvidia-offload.conf')
    ...
    nvidia_conf = open('/etc/X11/xorg.conf.d/10-nvidia-prime.conf', 'w+')
    nvidia_conf.write(nvidia)
    nvidia_conf.close()
